...
def validate_buy_and_merge_pet(action: ActionBuyAndMergePet, team_shop_state, max_pet_level: int) -> bool:
    return not (
        ...
        team_shop_state.team.pets[action.pet_position].level == max_pet_level
    )
